...
class Event_Registration_Public {
	...
	public function wpecr_registration( $atts ) {
		...
		if ( isset( $_POST['action'] ) && $_POST['action'] == 'order_send' ) {
			if ( ! wp_verify_nonce( $_POST['_wpnonce_order_form'], 'wpecr_form' ) ) {
				return false;
			}
	...
	public function all_countries( $sort_abc = false, $meta_box = false, $language = '' ) {
		...
		$all_countries_array_i18n['en'] = array(
			'AF' => 'Afghanistan',
			'AL' => 'Albania',
			'DZ' => 'Algeria',
			'AS' => 'American Samoa',
		...
		$all_countries_array_i18n['de'] = array(
			'AF' => 'Afghanistan',
			'AL' => 'Albanien',
			'DZ' => 'Algerien',
		...
		$all_countries_array_i18n['es'] = array(
			'AF' => 'Afganistán',
			'AL' => 'Albania',
			'DZ' => 'Argelia',
			'AS' => 'Samoa Americana',
		...
		$all_countries_array_i18n['pt'] = array(
			'AF' => 'Afeganistão',
			'AL' => 'Albânia',
			'DZ' => 'Argélia',
			'AS' => 'Samoa Americana',
		...
		$all_countries_array_i18n['fr'] = array(
			'AF' => 'Afghanistan',
			'AL' => 'Albanie',
			'DZ' => 'Algérie',
		...
		$all_countries_array_i18n['it'] = array(
			'AF' => 'Afghanistan',
			'AL' => 'Albania',
			'DZ' => 'Algeria',
			'AS' => 'Samoa americane',
		...
		$all_countries_array_i18n['nl'] = array(
			'AF' => 'Afghanistan',
			'AL' => 'Albanië',
			'DZ' => 'Algerije',
			'AS' => 'Amerikaans-Samoa',
	...
	public function currency_format( $money = 0.00, $currency = '&euro;' ) {
		//get currency symbol from Admin Options
		$options  = maybe_unserialize( get_option( $this->plugin_slug . 'options' ) );
