        ...
        <form action="<?php echo admin_url( 'admin-post.php' ) ?>" method="POST">
            ...
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="options[name]" id="name" class="regular-text"
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="options[email]" id="email" class="regular-text"
                ...
                <tr>
                    ...
                    <td>
						...
						<?php wp_editor( stripslashes( $options['before_txt'] ), 'before_txt', array(
							'textarea_name' => 'options[before_txt]',
							'media_buttons' => true,
							'tinymce'       => true,
							'textarea_rows' => 5
						) ); ?>
                ...
                <tr>
                    ...
                    <td>
						...
						<?php wp_editor( stripslashes( $options['after_txt'] ), 'after_txt', array(
							'textarea_name' => 'options[after_txt]',
							'media_buttons' => true,
							'tinymce'       => true,
							'textarea_rows' => 5
						) ); ?>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="options[before_message]" id="before_message" class="regular-text"
                               value="<?php echo $options['before_message'] ?>">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="options[terms]" id="terms" class="regular-text"
                               value="<?php echo $options['terms'] ?>">
                ...
                <tr>
                    ...
                    <td>
                        <fieldset>
                            <label for="showterms">
                                <input type="checkbox" name="options[showterms]" id="showterms"
                                       value="1" <?php echo $checked_showterms ?> >
                ...
                <tr>
                    ...
                    <td>
						...
						<?php wp_editor( stripslashes( $options['email_txt'] ), 'email_txt', array(
							'textarea_name' => 'options[email_txt]',
							'media_buttons' => true,
							'tinymce'       => true,
							'textarea_rows' => 8
						) ); ?>
            ...
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td>
                        <label for="showbank">
                            <input type="checkbox" name="options[showbank]" id="showbank"
                                   value="1" <?php echo $checked_showbank ?> >
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="options[currency]" id="currency" class="regular-text"
                ...
                <tr>
                    ...
                    <td>
						...
						<?php wp_editor( stripslashes( $options['bank_txt'] ), 'bank_txt', array(
							'textarea_name' => 'options[bank_txt]',
							'media_buttons' => false,
							'teeny'         => true,
							'textarea_rows' => 4
						) ); ?>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="options[bank]" id="bank" class="regular-text"
                               value="<?php echo $options['bank'] ?>">
                    </td>
                </tr>
                <tr>
                    <th scope="row">
                    ...
                    <td>
                        <input type="text" name="options[remittee]" id="remittee" class="regular-text"
                               value="<?php echo $options['remittee'] ?>">
                    </td>
                </tr>
                <tr>
                    <th scope="row">
                    ...
                    <td>
                        <input type="text" name="options[iban]" id="iban" class="regular-text"
                               value="<?php echo $options['iban'] ?>">
                    </td>
                </tr>
                <tr>
                    <th scope="row">
                    ...
                    <td>
                        <input type="text" name="options[bic]" id="bic" class="regular-text"
                               value="<?php echo $options['bic'] ?>">
                    </td>
                </tr>
                </tr>
                </tbody>
            ...
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td>
                        <fieldset>
                            <label for="support">
                                <input type="checkbox" name="options[support]" id="support"
                                       value="1" <?php echo $checked_support ?> >
            ...
            <button type="submit"
                    class="button button-primary button-large"><?php _e( 'Save', 'the-events-calendar-extension-registration' ) ?></button>

        </form>
    </div> <!-- end .column-left -->
    <div class="column column-right">
        <div class="wpecr_box">
            <img src="<?php echo plugins_url( 'img/e-colori-com_wordpress-plugins.png', dirname( __FILE__ ) ) ?>"
                 alt="www.e-colori.com" width="290" height="168" class="wpecr_img" id="wpecr_e-colori"/>
            ...
            <h3><a href="https://wordpress.org/support/plugin/the-events-calendar-extension-registration/">Support
                    (@wordpress.org)</a></h3>
            <br/>
            <p>
                <strong><?php _e( 'Do you like our plugin?', 'the-events-calendar-extension-registration' ) ?></strong><br/><?php _e( 'Thank you for your positive review on', 'the-events-calendar-extension-registration' ) ?>
            </p>
            <h3><a href="https://wordpress.org/support/plugin/the-events-calendar-extension-registration/reviews/">Review
                    (@wordpress.org)</a></h3>
            <br/>
            <h3>
                &raquo; <?php _e( 'You have questions or a feature request for the plugin?', 'the-events-calendar-extension-registration' ) ?></h3>
            <h3>
                <a href="http://wordpress.e-colori.com"><?php _e( 'Go to the plugin page', 'the-events-calendar-extension-registration' ) ?>
                    &raquo;</a></h3>
            <h3>
                <a href="http://wordpress.e-colori.com/the-events-calendar-extension-registration-pro/"><?php _e( 'Check out the PRO plugin', 'the-events-calendar-extension-registration' ) ?>
                    &raquo;</a></h3>
        </div>
